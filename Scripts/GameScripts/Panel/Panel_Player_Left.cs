...
namespace DYD
{
    public class Panel_Player_Left : Panel_Player
    {
        ...
        protected override void UpdatePosition_IN()
        {
            ...
            for (int i = 0; i < MJ_IN_List.Count; i++)
            {
                ...
                pos.y -= i * GameGD.MJ_LEFT_IN_SPACE;
        ...
        protected override void UpdatePosition_OUT()
        {
            for (int i = 0; i < MJ_OUT_List.Count; i++)
            {
                ...
                pos.y -= GameGD.MJ_LEFT_OUT_SPACE_W * (i % GameGD.MJ_OUT_COL_SUM);
                pos.x -= GameGD.MJ_LEFT_OUT_SPACE_H * (i / GameGD.MJ_OUT_COL_SUM);
        ...
        protected override Vector3 GetMJStartPos_IN()
        {
            ...
            pos.y += MJ_IN_List.Count * GameGD.MJ_LEFT_IN_SPACE;
        ...
        protected override Vector3 GetLastPosition_CPG()
        {
            ...
            {
                pos.y -= GameGD.MJ_LEFT_CPG_SPACE * (MJ_CPG_List.Count - 1);
        ...
        protected override void SortMJDepth()
        {
            ...
            for (int i = 0; i < MJ_CPG_List.Count; i++)
            {
